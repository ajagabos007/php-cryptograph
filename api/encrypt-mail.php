<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        try {
            ...
            $link = $protocol.$_SERVER['HTTP_HOST']."/decrypt-email.php?res=". uniqid("",true)."&des_operation=decryption&salt=". uniqid("",true)."&uuid=".$uuid."&hash=". uniqid("",true);
             //Content of email 
            ...
            $message .="<p><small> <a href='".$link."'target='_blank'>".$link."</a></small></p>";
            ...
            $response = array(
                "status" => 422,
                "message" => "Mailing operation failed <br/>".$th->getMessage(),
            );
            echo json_encode($response);
            exit();
        }
